"undefined" == typeof jwplayer && (jwplayer = function(e) {
    ...
    e.key = function(a) {
        ...
        try {
            ...
            var d = a.split("/");
            (l = d[0]) ? /^(free|pro|premium|ads)$/i.test(l) ? (g = d[1], d[2] && 0 < parseInt(d[2]) && (f = new Date, f.setTime(String(d[2])))) : l = "invalid" : l = "free"
        } catch (c) {
            l = "invalid"
        }
    }
    ...
    e.plugin = function(g) {
        ...
        a.extend(this, n);
        this.load = function() {
            if (m == a.loaderstatus.NEW) if (0 < g.lastIndexOf(".swf")) b = g, m = a.loaderstatus.COMPLETE, n.sendEvent(l.COMPLETE);
    ...
    (e.embed.flash = function(d, c, m, b, p) {
        ...
        this.embed = function() {
            ...
            v.base = e + "/";
            g[d.id] = v;
            a.isIE() ? (e = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width="100%" height="100%"id="' + d.id + '" name="' + d.id + '" tabindex=0"">', e += '<param name="movie" value="' + c.src + '">', e += '<param name="allowfullscreen" value="true"><param name="allowscriptaccess" value="always">', e += '<param name="seamlesstabbing" value="true">', e += '<param name="wmode" value="' + f + '">', e += '<param name="bgcolor" value="#000000">', e += "</object>", d.outerHTML = e, f = document.getElementById(d.id)) : (e = document.createElement("object"), e.setAttribute("type", "application/x-shockwave-flash"), e.setAttribute("data", c.src), e.setAttribute("width", "100%"), e.setAttribute("height", "100%"), e.setAttribute("bgcolor", "#000000"), e.setAttribute("id", d.id), e.setAttribute("name", d.id), e.setAttribute("tabindex", 0), h(e, "allowfullscreen", "true"), h(e, "allowscriptaccess", "always"), h(e, "seamlesstabbing", "true"), h(e, "wmode", f), d.parentNode.replaceChild(e, d), f = e);
    ...
    e.embed = l.extend(function(f) {
        ...
        var c = l.repo(),
            ...
            h = b.plugins,
            q = b.analytics,
            n = "../js/min/jwplayer/jwpsrv.js",
            k = "../js/min/jwplayer/sharing.js",
            j = "../js/min/jwplayer/related.js",
            u = "../js/min/jwplayer/gapro.js",
            m = e.key ? e.key : m.key,
        ...
        switch (t) {
            ...
            case "premium":
                b.related && (g.test(b.related.client) && (j = b.related.client), h[j] = b.related), b.ga && (g.test(b.ga.client) && (u = b.ga.client), h[u] = b.ga);
            case "pro":
